...
<head>
    ...
    <title>{{ config('app.name', 'Vollva4') }}</title>
                        ...
                        <li >
                         ...
                         <li class="dropdown">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                ...
                                <li><a href="{{route('admin.question.unanswered')}}">Вопросы без ответов.</a></li>
                                <li><a href="{{route('admin.user.index')}}">Администраторы</a></li>
                            </ul>
                        </li>
                    </ul>
